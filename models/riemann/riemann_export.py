...
TESTING_DIR = os.path.join(MODEL_DIR, "riemann_testing")
BEST_CONFIG_CSV = os.path.join(TESTING_DIR, "all_combinations_summary.csv")
MODEL_PATH = os.path.join(MODEL_DIR, "riemann_model.joblib")
METADATA_PATH = os.path.join(MODEL_DIR, "riemann_metadata.json")
...
if __name__ == "__main__":
    ...
    best_config = {"cov_estimator": best["cov_estimator"], "ts_metric": best["ts_metric"], "C": parse_value(best["C"]), "solver": best["solver"], "class_weight": parse_value(best["class_weight"])}
