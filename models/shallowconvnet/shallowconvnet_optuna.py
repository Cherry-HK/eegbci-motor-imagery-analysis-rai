...
def suggest_params(trial):
    return {
        ...
        "filter_length": trial.suggest_categorical("filter_length", [15, 35]),
        "pool_length": trial.suggest_categorical("pool_length", [50, 75]),
        "pool_stride": trial.suggest_categorical("pool_stride", [15, 20]),
