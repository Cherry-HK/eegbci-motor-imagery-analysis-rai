...
RESULTS_DIR = os.path.join("models", "shallowconvnet", "shallowconvnet_testing")
...
if __name__ == "__main__":
    ...
    write_csv(os.path.join(RESULTS_DIR, "all_combinations_summary.csv"), summary_rows, list(summary_rows[0].keys()))
    write_csv(os.path.join(RESULTS_DIR, "all_combinations_fold_results.csv"), fold_rows, list(fold_rows[0].keys()))
    write_csv(os.path.join(RESULTS_DIR, "all_combinations_train_loss.csv"), loss_rows, list(loss_rows[0].keys()))
    write_csv(os.path.join(RESULTS_DIR, "top_10_combinations.csv"), top_10_rows, list(top_10_rows[0].keys()))
    write_csv(
    ...
    save_confusion_matrix_plot(
        ...
        best_result["overall_confusion_matrix"],
        "ShallowConvNet Best Configuration Confusion Matrix",
    )
    plot_top_combinations(
        os.path.join(RESULTS_DIR, "top_10_combinations.png"),
        summary_rows,
        top_n=10,
        model_label="ShallowConvNet",
    ...
    print("Saved ShallowConvNet testing outputs to:", RESULTS_DIR)
