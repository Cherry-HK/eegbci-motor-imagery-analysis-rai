...
TESTING_DIR = os.path.join(MODEL_DIR, "shallowconvnet_testing")
BEST_CONFIG_CSV = os.path.join(TESTING_DIR, "all_combinations_summary.csv")
MODEL_PATH = os.path.join(MODEL_DIR, "shallowconvnet_model.pth")
METADATA_PATH = os.path.join(MODEL_DIR, "shallowconvnet_metadata.json")
...
def load_best_configuration(path):
    best_row = load_best_row(path, "models/shallowconvnet/shallowconvnet_testing.py")
    return {
...
if __name__ == "__main__":
    ...
    print("Loaded best ShallowConvNet configuration:", best_config)
    print("Device:", DEVICE)
    ...
    print("Saved ShallowConvNet weights to:", MODEL_PATH)
