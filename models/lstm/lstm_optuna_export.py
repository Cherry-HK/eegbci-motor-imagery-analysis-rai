...
def load_best_configuration(path):
    best_row = load_best_row(path, "models/lstm/lstm_optuna.py")
    return {
...
if __name__ == "__main__":
    ...
    print("Loaded best LSTM Optuna configuration:", best_config)
    print("Device:", DEVICE)
    ...
    print("Saved LSTM Optuna weights to:", MODEL_PATH)
