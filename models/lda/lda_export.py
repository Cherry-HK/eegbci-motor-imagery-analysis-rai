...
if __name__ == "__main__":
    ...
    best_config = {"solver": best["solver"], "shrinkage": parse_value(best["shrinkage"]), "csp_components": parse_value(best["csp_components"])}
