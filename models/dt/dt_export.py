...
if __name__ == "__main__":
    ...
    best_config = {"criterion": best["criterion"], "max_depth": parse_value(best["max_depth"]), "min_samples_split": parse_value(best["min_samples_split"]), "min_samples_leaf": parse_value(best["min_samples_leaf"]), "class_weight": parse_value(best["class_weight"]), "csp_components": parse_value(best["csp_components"])}
    ...
    classifier = DecisionTreeClassifier(criterion=best_config["criterion"], max_depth=best_config["max_depth"], min_samples_split=best_config["min_samples_split"], min_samples_leaf=best_config["min_samples_leaf"], class_weight=best_config["class_weight"], random_state=42)
