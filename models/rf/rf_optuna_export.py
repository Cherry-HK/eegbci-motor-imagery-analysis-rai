...
OPTUNA_DIR = os.path.join(MODEL_DIR, "rf_optuna")
BEST_CONFIG_CSV = os.path.join(OPTUNA_DIR, "all_trials_summary.csv")
MODEL_PATH = os.path.join(MODEL_DIR, "rf_optuna_model.joblib")
METADATA_PATH = os.path.join(MODEL_DIR, "rf_optuna_metadata.json")
...
if __name__ == "__main__":
    ...
    best_config = {
        ...
        "n_estimators": parse_value(best["n_estimators"]),
        ...
        "max_features": parse_value(best["max_features"]),
