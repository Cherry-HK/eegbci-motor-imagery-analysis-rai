...
RESULTS_DIR = os.path.join("models", "cnn", "cnn_optuna")
    ...
    for row in top_rows[:3]:
        lines.append(
            (
                ...
                f"depth_multiplier={row['depth_multiplier']}, kernel_length={row['kernel_length']}, "
