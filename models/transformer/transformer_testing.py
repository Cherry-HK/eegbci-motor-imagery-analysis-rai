...
RESULTS_DIR = os.path.join("models", "transformer", "transformer_testing")
...
if __name__ == "__main__":
    ...
    save_confusion_matrix_plot(
        ...
        best_result["overall_confusion_matrix"],
        "Transformer Best Configuration Confusion Matrix",
    )
    plot_top_combinations(
    ...
    print("Saved Transformer testing outputs to:", RESULTS_DIR)
