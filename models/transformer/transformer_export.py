...
TESTING_DIR = os.path.join(MODEL_DIR, "transformer_testing")
...
def load_best_configuration(path):
    best_row = load_best_row(path, "models/transformer/transformer_testing.py")
    return {
...
if __name__ == "__main__":
    ...
    print("Loaded best Transformer configuration:", best_config)
    print("Device:", DEVICE)
    ...
    print("Saved Transformer weights to:", MODEL_PATH)
