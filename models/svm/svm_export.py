...
TESTING_DIR = os.path.join(MODEL_DIR, "svm_testing")
...
def load_best_configuration(path):
    if not os.path.exists(path):
        raise FileNotFoundError(
            f"Best-configuration CSV not found: {path}. Run models/svm/svm_testing.py first."
        )
...
if __name__ == "__main__":
    ...
    print("Loaded best SVM configuration:", best_config)
